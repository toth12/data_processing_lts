...
def process(data,id_,_id,shelf_mark,client):
    ...
    try:
        ...
        annotated_folia_xml.save('scripts/create-fragments-collections/test_data/'+id_+'.xml')
...
def main():
    ...
    testimony_ids=['irn41498','irn508320','irn506665','irn506640','irn47889','irn510724']
    for i,testimony_id in enumerate(testimony_ids):
        print i
        with corenlp.CoreNLPClient(annotators="tokenize ssplit pos lemma".split(),properties={'timeout': '50000'}) as client:
            ...
            results=h.query(DB, 'testimonies', {'testimony_id':testimony_id}, {'testimony_id':1,'structured_transcript':1,'shelfmark':1,'collection':'1'} )   
