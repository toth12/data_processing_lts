...
def main():
    ...
    results=h.query(DB, 'testimonies', {'testimony_id':'irn508630'}, {'testimony_id':1,'structured_transcript':1,'shelfmark':1,'collection':1,'camp_names':1,'ghetto_names':1,'gender':1,'interviewee_name':1,'recording_year':1} )   
